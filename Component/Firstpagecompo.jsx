export function Growingcommunity(props) {
  return (
    <div className="col-10 col-md-6 col-lg-2 text-center mb-4"
      style={{padding: "20px",borderRadius: "20px",backgroundColor: "#fff7f7ff",
        boxShadow: "0 3px 12px rgba(0, 0, 0, 0.66)",}}>
      <span className="d-inline-flex justify-content-center align-items-center"
        style={{backgroundColor: "#c41d00",
          borderRadius: "50%",width: "60px",height: "60px",
          color: "white",fontSize: "30px",}}>{props.icon}</span>
...
export function Weoffer(props) {
  return (
    <div className="col-10 col-md-6 col-lg-3 mb-4"
      style={{padding: "20px",borderRadius: "20px",backgroundColor: "#fff2f2ff",
...
export function Upcommingevents(props) {
  return (
    <div className="col-10 col-md-6 col-lg-3 mb-4"
      style={{padding: "10px",borderRadius: "5px",backgroundColor: "#deffe1ff",
